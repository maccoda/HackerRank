...
public class SnakesAndLadders {
	...
	/**
	 * Given a board find the minimum number of rolls(edges traversed) required
	 * to go from the start to the finish
	 * 
...
/**
 * This class creates a 100 node graph to represent the 100 value board for the
 * snakes and ladders board game. It will initialise the 100 nodes as well as
 * have the ability to add snakes or ladders. This will be done by adjusting the
 * connections of the node as usually it can move 1-6 spaces ahead whereas if it
 * has a snake or ladder on it the only option is to take that path
 * 
 * @author dmaccora
 *
 */
